  ...
  <div class="pendentes-wrapper">
    ...
    <section class="pendentes-section" v-if="pagamentosPendentes.length || carregandoPagamentos">
      <h2 class="pendentes-section__title">
        ...
        <span class="pendentes-section__count pendentes-section__count--pix" v-if="pagamentosPendentes.length">
      ...
      <div v-else class="cards-grid">
        <div
          v-for="p in pagamentosPendentes"
          :key="p.payment_id"
          class="payment-card"
        >
          <div
            class="payment-card__img"
            :style="p.property.image ? { backgroundImage: `url('${encodeURI(p.property.image)}')` } : {}"
          />
          <div class="payment-card__body">
            ...
            <button class="payment-card__btn" @click="abrirPix(p)">
              Pagar com PIX
            </button>
          </div>
        </div>
...
.pendentes-section { display: flex; flex-direction: column; gap: 20px; }
...
.pendentes-section__title span:first-of-type { color: #1a2fa8; }
...
.pendentes-section__count--pix { background: #16a34a; }

.estado      { font-size: 14px; opacity: 0.6; margin: 0; }
.estado.erro { color: #dc2626; opacity: 1; }
...
.payment-card__prazo--urgente { color: #dc2626; background: #fee2e2; }
...
.payment-card__btn:hover { background: #15803d; }
</style>
