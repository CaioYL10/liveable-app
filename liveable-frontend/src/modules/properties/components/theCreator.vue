  ...
  <div class="all">
    ...
    <div class="mais-detalhes">
      ...
      <div class="mais-detalhes-options">
        <div class="esquerda">
          <label><input type="checkbox" v-model="wifi" /><PhWifiHigh class="mais-detalhes-icons" /> Wi-fi</label>
          <label><input type="checkbox" v-model="tv" /><PhMonitor class="mais-detalhes-icons" /> TV</label>
          <label><input type="checkbox" v-model="refrigerador" /><PhSidebar class="mais-detalhes-icons" /> Refrigerador</label>
          <label><input type="checkbox" v-model="fumaca" /><PhCigarette class="mais-detalhes-icons" /> Det. fumaça</label>
        </div>
        <div class="direita">
          <label><input type="checkbox" v-model="ar" /><PhSnowflake class="mais-detalhes-icons" /> Ar condicionado</label>
          <label><input type="checkbox" v-model="maquina_lavar" /><PhWashingMachine class="mais-detalhes-icons" /> Máq. de lavar</label>
          <label><input type="checkbox" v-model="micro_ondas" /><PhHardDrive class="mais-detalhes-icons" /> Micro-ondas</label>
        </div>
      </div>
    </div>
